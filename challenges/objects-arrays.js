...
*/
// let lowerPopulation = [];
// lowerPopulation = zooAnimals.filter((animal) => {return animal.population < 5});
// console.log(lowerPopulation);

const lowerPopulation = [];
lowerPopulation.push(zooAnimals.filter(animal => {return animal.population < 5}));
console.log(lowerPopulation);
...
populationTotal = zooAnimals.reduce((total, animal) => {return total += animal.population}, 0);
